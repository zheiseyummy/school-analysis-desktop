/*
* kindergarten_health_checkup 权限系统数据库(MySQL8.x)
* @author haoxr
*/
...
-- 1. 创建数据库
-- ----------------------------
CREATE DATABASE IF NOT EXISTS kindergarten_health_checkup DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;


-- ----------------------------
-- 2. 创建表 && 数据初始化
-- ----------------------------
use kindergarten_health_checkup;
...
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 89);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 90);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 91);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 92);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 93);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 94);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 95);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 96);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 97);
INSERT INTO `kindergarten_health_checkup`.`sys_role_menu` (`role_id`, `menu_id`) VALUES (2, 102);
