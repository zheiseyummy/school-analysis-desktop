...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements SysDictService {
    ...
    public Page<DictPageVO> getDictPage(DictPageQuery queryParams) {
        ...
        Page<SysDict> dictItemPage = this.page(
                ...
                new LambdaQueryWrapper<SysDict>()
                        ...
                        .select(SysDict::getId, SysDict::getName, SysDict::getValue, SysDict::getStatus, SysDict::getSort)
        );
    ...
    @Override
    public Map<String, String> mapDictOptions(String typeCode) {
        List<Option> optionList = listDictOptions(typeCode);
        return optionList.stream().collect(Collectors.toMap(it -> it.getValue().toString(), it -> it.getLabel()));
    }

    @Override
    public List<DictTypeDictBO> getAllDictTypeDictList() {
        return this.baseMapper.getAllDictTypeDictList();
    }

    @Override
    public Map<String, DictTypeDictBO> getAllDictTypeDictMap() {
        return getAllDictTypeDictList().stream().collect(Collectors.toMap(DictTypeDictBO::getTypeCode, it -> it));
    }
}
